...
*) Build MQTT Driver
   ...
   cd C:\Tools\oa4j\Project\Drivers\Kafka
...
WCCOAjavadrv -num 2 -cp bin\winccoa-kafka-0.1.jar -broker <server1>:9092,<server2>:9092,<server3>:9092 -topic <topic> -groupid <groupid>
